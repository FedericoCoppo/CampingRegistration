...
The program has been developed in CodeComposer environment several years ago, just to approach to C++, and it contains several architecture errors and it is outdated.
...
allow to memorize data of holidaymakers that has been already registered, so this tool has become unuseful.   
